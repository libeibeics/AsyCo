...
def cifar10_dataloaders(data_dir,rate, flag_aug=True):
    print('Data Preparation')
    cifar10_train_ds = MY_CIFAR10(data_dir, train=True, download=True,rate_partial=rate,flag_aug=flag_aug)
...
def svhn_dataloaders(data_dir,rate, flag_aug=True):
    print('Data Preparation')    
    svhn_train_ds = MY_SVHN(data_dir, split='train', download=True,rate_partial=rate, flag_aug=flag_aug)
    train_loader = torch.utils.data.DataLoader(
        svhn_train_ds,
        batch_size=64,
        shuffle=True,
...
def cifar100_dataloaders(data_dir,rate, flag_aug=True, batch_size=64):
    print('Data Preparation')
    cifar100_train_ds = MY_CIFAR100(data_dir, train=True, download=True,rate_partial=rate, flag_aug=flag_aug)
    train_loader = torch.utils.data.DataLoader(
        cifar100_train_ds,
